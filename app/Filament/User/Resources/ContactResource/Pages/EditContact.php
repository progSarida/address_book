        ...
        return [
            ...
            Actions\Action::make('previous_a_contact')
                ...
                ->action(function () use ($previousAContact) {
                    $this->redirect(ContactResource::getUrl('edit', ['record' => $previousAContact->id]));
                }),
            Actions\Action::make('next_a_contact')
                ...
                ->action(function () use ($nextAContact) {
                    $this->redirect(ContactResource::getUrl('edit', ['record' => $nextAContact->id]));
                }),
            // Scorrimento id
            Actions\Action::make('previous_i_contact')
                ...
                ->action(function () use ($previousIContact) {
                    $this->redirect(ContactResource::getUrl('edit', ['record' => $previousIContact->id]));
                }),
            Actions\Action::make('next_i_contact')
                ...
                ->action(function () use ($nextIContact) {
                    $this->redirect(ContactResource::getUrl('edit', ['record' => $nextIContact->id]));
                }),
